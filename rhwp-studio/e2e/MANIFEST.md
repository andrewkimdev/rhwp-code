...
| `pua-f02fb-small-right-triangle-canvas2d.test.mjs` | 상시 | active | 한컴 문자표 U+F02FB 일반 TextRun을 작은 오른쪽 방향 삼각형으로 Canvas2D 투영 | basic/pau-004.hwp | npm e2e:pua-f02fb | raw IR 보존·공개 글꼴 tofu 차단 |
