...
현재는 P1~P5 개발자 미리보기이며, 원장 기준 **308/484** 항목이 한글 2022 COM Oracle과 0 diff 로
대조됐다. 남은 176 중 171 은 이 하니스로 구조적으로 못 재는 것들이고(대화상자·안 끝남·
관측창 없음·숨은 상태·글자 폭 정밀도 따위), 나머지는 **막힌 것이 아니라 아직 안 이었거나 더
잴 맥락이 필요한 것**이다. **도달 가능한 상한은 313** 이다. 갈래와 그 이유는
`tools/hwpctrl_compat/classify_remaining.py` 가 낸다.
