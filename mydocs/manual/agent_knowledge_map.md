...
| 평문 개인정보 검사만(파일 무변경) | `edit redact --dry-run --no-raw --json` (`hwp_redact`) | `findingCount`·`findings[].masked` | [레시피 3](recipes/03_redact_before_sharing.md)·[보안 소비자 가이드](../tech/agent_security/consumer_guide.md) |
